...
$noTrustSubnetCIDR = "10.248.8.0/29",
...
$vnetParams = @{
    ...
    'subnet7Name' = $DMZSubnetName;
    'subnet8Prefix' = $noTrustSubnetCIDR;
    'subnet8Name' = $noTrustSubnetName;
    'subnet9Prefix' = $VDIsubnetPrefix;
    'subnet9Name' = $VDIsubnetName
}
...
$panParams = @{
    ...
    'PublicIPAddress1Name' = $panMgmtPublicDNSName;
    'PublicIPAddress2Name' = $panPublicIPAddressName
    'storageAccountName' = $storageName;
